 ...
 * @author Luis Rafael
 */
public class EncabezadoRegistroProveedor extends JPanel {
    ...
    private Long idCoordinadorDeLogistica;
    
    
    public EncabezadoRegistroProveedor(IVista vistaPadre) {
        this.idCoordinadorDeLogistica = 1L;
