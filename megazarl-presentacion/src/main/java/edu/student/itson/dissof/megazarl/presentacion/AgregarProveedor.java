 ...
 * ID: 00000252607
 */
public class AgregarProveedor extends JFrame implements IVista{
    ...
    private Encabezado2 encabezado;
    ...
    public AgregarProveedor(ControlAgregarProveedor control) {
    ...
    private void initComponents(){
        ...
        encabezado = new Encabezado2(this);
        ...
        panelDatosProveedor = new AgregarProveedor.PanelRedondeado(10, new Color(226, 234, 206));
    ...
    public static void main(String[] args) {
        ControlAgregarProveedor controlAgregarProveedor = new ControlAgregarProveedor();
        IVista agregarProveedor = new AgregarProveedor(controlAgregarProveedor);
        agregarProveedor.hacerVisible(true);
    }
}
