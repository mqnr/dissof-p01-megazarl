 ...
 * PaqueteriasIdClienteInvalidoException.java
 ...
 de un cliente que no existe o no es válido en el sistema.
 *
 ...
 *
 */
public class PaqueteriasIdClienteInvalidoException extends Exception{
    /**
     * Constructor por defecto.
     */
    public PaqueteriasIdClienteInvalidoException() {
    }
     ...
     */
    public PaqueteriasIdClienteInvalidoException(String message) {
        super(message);
    }
}
