...
/**
 * PaqueteriasIdProveedorInvalidoException.java
 *
 ...
 *
 */
public class PaqueteriasIdProveedorInvalidoException extends Exception{
    
    /**
     * Constructor por defecto.
     */
    public PaqueteriasIdProveedorInvalidoException() {
    }
     ...
     */
    public PaqueteriasIdProveedorInvalidoException(String message) {
        super(message);
    }
}
