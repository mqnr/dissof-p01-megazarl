...
/**
 * MontoMinimoEnvioGratuitoDTONegocios.java
 ...
 *
 */
public class MontoMinimoEnvioGratuitoDTONegocios {
    private double montoMinimo;
    private double montoActual;

    public MontoMinimoEnvioGratuitoDTONegocios(double montoMinimo, double montoActual) {
