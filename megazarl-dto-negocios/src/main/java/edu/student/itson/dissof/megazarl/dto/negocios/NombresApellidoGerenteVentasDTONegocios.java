...
/**
 * NombresApellidoGerenteVentasDTONegocios.java
 ...
 *
 */
public class NombresApellidoGerenteVentasDTONegocios {
    
    private String nombresGerenteVentas;
    private String apellidoPaternoGerenteVentas;

    public NombresApellidoGerenteVentasDTONegocios(String nombresGerenteVentas, String apellidoPaternoGerenteVentas) {
