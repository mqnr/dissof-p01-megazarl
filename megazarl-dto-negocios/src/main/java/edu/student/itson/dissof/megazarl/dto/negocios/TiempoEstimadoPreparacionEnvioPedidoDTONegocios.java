...
/**
 * TiempoEstimadoPreparacionEnvioPedidoDTONegocios.java
 ...
 *
 */
public class TiempoEstimadoPreparacionEnvioPedidoDTONegocios {
    private int diasLimiteInferior;
    private int diasLimiteSuperior;

    public TiempoEstimadoPreparacionEnvioPedidoDTONegocios(int diasLimiteInferior, int diasLimiteSuperior) {
