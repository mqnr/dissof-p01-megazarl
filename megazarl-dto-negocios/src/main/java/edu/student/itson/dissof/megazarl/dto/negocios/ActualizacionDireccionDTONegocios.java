 ...
 *
 */
public class ActualizacionDireccionDTONegocios {
     ...
     */
    public ActualizacionDireccionDTONegocios(Long id, String estado, String ciudad, String codigoPostal, String colonia, String calle, String numero) {
        this.id = id;
        this.estado = estado;
        this.ciudad = ciudad;
