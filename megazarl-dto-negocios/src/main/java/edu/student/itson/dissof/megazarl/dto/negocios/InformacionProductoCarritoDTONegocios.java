...
/**
 * InformacionProductoCarritoDTONegocios.java
 ...
 *
 */
public class InformacionProductoCarritoDTONegocios {
    ...
    public InformacionProductoCarritoDTONegocios(IdEntidadGenericoNegocios id, Integer cantidad) {
        this.id = id;
