...
public class ManejadorConexiones {
    ...
    public static EntityManager getEntityManager(){
        ...
        if(conexionTest){
            emFactory = Persistence.createEntityManagerFactory("edu.student.itson.dissof_megazarl-administrador-mysql_tests_jar_1.0-SNAPSHOTPU2");
        } else{
            emFactory = Persistence.createEntityManagerFactory("edu.student.itson.dissof_megazarl-administrador-mysql_jar_1.0-SNAPSHOTPU");
        }
