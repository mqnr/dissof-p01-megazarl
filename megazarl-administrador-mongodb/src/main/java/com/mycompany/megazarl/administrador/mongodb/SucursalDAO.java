...
import edu.student.itson.dissof.dto.datos.SucursalIdsRelacionesDTO;
...
public class SucursalDAO {
    ...
    public boolean existePorId(IdEntidadGenerico idSucursalDTO) 
    ...
    public SucursalIdsRelacionesDTO recuperarPorId(IdEntidadGenerico idSucursalDTO) 
    ...
    private ObjectId validarYConvertirDireccion(IdEntidadGenerico idDireccionDTO) 
        throws FormatoInvalidoIdConversionException, RegistroInexistenteException {
    ...
    private SucursalIdsRelacionesDTO convertirSucursalADTO(Sucursal sucursal) {
        IdEntidadGenerico idSucursal = new IdEntidadGenerico(sucursal.getId().toHexString());
        
        IdEntidadGenerico idDireccion = null;
        if (sucursal.getDireccion() != null && sucursal.getDireccion().getId() != null) {
            idDireccion = new IdEntidadGenerico(sucursal.getDireccion().getId().toHexString());
        }
