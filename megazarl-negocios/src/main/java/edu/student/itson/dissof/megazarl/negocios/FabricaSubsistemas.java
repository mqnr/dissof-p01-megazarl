...
package edu.student.itson.dissof.megazarl.negocios;
...
public class FabricaSubsistemas {
    ...
    public static IAdministradorPaqueterias obtenerAdministradorPaqueterias(DireccionDTONegocios direccionDefectoPaqueteria){
    ...
    public static IAdministradorPedidos obtenerAdministradorPedidos(DireccionDTONegocios direccionDefectoPaqueteria){
    ...
    public static IAdministradorCarritoCompras obtenerAdministradorCarritoCompras(Double montoMinimoEnvioPedido, DireccionDTONegocios direccionDefectoPaqueteria){
