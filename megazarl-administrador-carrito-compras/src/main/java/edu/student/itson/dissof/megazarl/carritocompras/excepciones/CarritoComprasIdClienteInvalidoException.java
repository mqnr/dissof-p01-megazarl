 ...
 * 
 * Clase que representa una excepción lanzada cuando el ID de un Cliente
 ...
 * ID: 00000251923
 */
public class CarritoComprasIdClienteInvalidoException extends Exception{

    /**
     * Contructor por defecto.
     */
    public CarritoComprasIdClienteInvalidoException() {
    }
     ...
     */
    public CarritoComprasIdClienteInvalidoException(String message) {
        super(message);
    }
