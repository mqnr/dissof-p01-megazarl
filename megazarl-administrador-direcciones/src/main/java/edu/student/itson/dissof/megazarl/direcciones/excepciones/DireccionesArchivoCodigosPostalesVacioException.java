...
/**
 * DireccionesArchivoCodigosPostalesVacioException.java
 ...
 * 
 */
public class DireccionesArchivoCodigosPostalesVacioException extends Exception{
    
    /**
     * Constructor por defecto
     */
    public DireccionesArchivoCodigosPostalesVacioException() {
    }
     ...
     */
    public DireccionesArchivoCodigosPostalesVacioException(String message) {
        super(message);
    }
}
