...
/**
 * SucursalIdInvalidoException.java
 *
 ...
 *
 */
public class SucursalIdInvalidoException extends Exception {

    public SucursalIdInvalidoException() {
    }

    public SucursalIdInvalidoException(String msg) {
        super(msg);
    }
}