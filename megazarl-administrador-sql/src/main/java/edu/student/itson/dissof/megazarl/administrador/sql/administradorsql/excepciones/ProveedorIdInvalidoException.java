...
/**
 * ProveedorIdInvalidoException.java
 *
 ...
 *
 */
public class ProveedorIdInvalidoException extends Exception{

    public ProveedorIdInvalidoException() {
    }

    public ProveedorIdInvalidoException(String msg) {
        super(msg);
    }
}
